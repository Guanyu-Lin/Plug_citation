...
from .ASQA.ASQAFormatter import ASQAPlugDFormatter
from .Hybrid.HybridFormatter import HybridPlugDFormatter
...
formatter_list = {
    ...
    "ASQAPlugD": ASQAPlugDFormatter,
    "HybridPlugD": HybridPlugDFormatter,

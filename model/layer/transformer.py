...
from .blocks import SelfAttentionBlock, CrossAttentionBlock, FFNBlock, TransformerPlugBlock
...
class Encoder(torch.nn.Module):
		...
		def forward(self, hidden_states : torch.Tensor,
				...
				if not use_cache:
						...
						hidden_states = self.layers(hidden_states, attention_mask, position_bias, prefix_mask, \
															parameters, deltas, return_plug, None, None, None, None, False, save_score)
						...
						with torch.no_grad():
								...
								for i, module in enumerate(self.layers):
										...
										hidden_states  = module(hidden_states, attention_mask, position_bias, prefix_mask, parameters, deltas, 
																						return_plug, None, None, None, 
																						past_key_values[i] if past_key_values else None, 
																						use_cache, save_score)
